...
from keyboards.keyboards import check_out_the_warranty__keyboard
...
async def check_out_the_warranty_handlers(callback_query: types.CallbackQuery) -> None:
    ...
    await bot.send_message(callback_query.from_user.id, sign_up_text, reply_markup=check_out_the_warranty__keyboard(),
