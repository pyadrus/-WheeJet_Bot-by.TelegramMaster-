...
async def new_guarantee_chek_3_years_handlers(message: Message, state: FSMContext):
    ...
    try:
        ...
        if customer:
            ...
            print(
                f"Найдено: {telegram_id}, {telegram_username}, {product_code}, {order_number}, {product_photo}, {full_name}, {contact}, {communication_method}, {date_of_purchase}, {tipe_shop}, {warranty_number}")
        else:
        ...
        filling_data_hourly_rate(file_dog, product_code[0], full_name[0], date_of_purchase[0], communication_method[0],
                                 contact[0],
...
def payment_yookassa_program_setup_service_3():
    ...
    try:
        ...
        payment = Payment.create(
            {
                "amount": {
                    "value": 2200.00, "currency": "RUB"
                }, "capture": True,
                "confirmation": {
                    "type": "redirect",
                    "return_url": "https://t.me/WheeJet_Bot"
                },
                "description": "Расширенная гарантия 3 года",
                "metadata": {'order_number': '1'},
                "receipt": {"customer":
                                {"email": "Tim.kylikoff@gmail.com"},
                            "items": [
                                {
